...
//  Knock-Knock
//
//  Created by Owen Donckers on 3/1/21.
//
...
extension Color {
    ...
    static var label = Color("LabelColor")
    static var secondaryLabel = Color("SecondaryLabelColor")

    static var cardBackground = Color("CardBackgroundColor")
    static var groupedBackground = Color("GroupedBackgroundColor")
