    ...
    @ViewBuilder private var form: some View {
        Form {
            ...
            Section(header: Text("Street Info")) {
                ...
                // City Field
                TextField("Optional", text: $viewModel.city)
                    .formLabel("City")
                
                // State Field
                TextField("Optional", text: $viewModel.state)
                    .formLabel("State")
        ...
        .onAppear {
            viewModel.location.request()
        }
        .onDisappear {
            viewModel.location.stopUpdatingPlacement()
        }
    }
...
struct RecordFormView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        .onAppear {
            setSegmentedControlAppearance(selectedTintColor: .systemGreen, selectedForegroundColor: .white)
        }
    }
}
