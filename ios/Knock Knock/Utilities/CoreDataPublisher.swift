...
class CoreDataPublisher<Entity: NSManagedObject>: NSObject, NSFetchedResultsControllerDelegate, Publisher {
    ...
    func controllerDidChangeContent(
        ...
        guard let result = controller.fetchedObjects as? [Entity]
        else { return }
