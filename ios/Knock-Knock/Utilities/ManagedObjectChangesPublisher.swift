...
//  Knock-Knock
//
//  Created by Owen Donckers on 3/22/21.
//
...
struct ManagedObjectChangesPublisher<Object: NSManagedObject>: Publisher {
    ...
    private final class Inner<Downstream: Subscriber>: NSObject, Subscription, NSFetchedResultsControllerDelegate where Downstream.Input == CollectionDifference<Object>, Downstream.Failure == Error {
